...
|24 September 2026 | Gemini |Apa saja trade-off dari penggunaan arsitektur SOA yang dikombinasikan dengan MOM pada studi kasus FoodGo?|Menjelaskan tantangan kompleksitas debugging (alur asinkron tidak linear), risiko duplikasi/kehilangan pesan di antrean yang memerlukan mekanisme tambahan seperti idempotency, serta peningkatan biaya operasional dan infrastruktur (harus mengelola message broker tambahan seperti RabbitMQ/Kafka).|Menyesuaikan poin-poin trade-off tersebut dengan konteks FoodGo.|
|24 September 2026 | Gemini | Ketika terdapat beberapa notif yang ditunjukkan ke dalam 1 orang saja, apakah bisa jika sistem menggunakan PubSub via MOM? | Menjelaskan bahwa arsitektur MOM memiliki fitur yang dapat mengirimkan pesan spesifik ke 1 orang atau modul tertentu saja | Memahami dan menyeleraskan dengan arsitektur yang ingin digunakan
